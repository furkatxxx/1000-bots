...
- 8-10: Выдающаяся идея с доказанным спросом, понятной экономикой
- 6-7: Хорошая идея с потенциалом, есть что проверить, но основа крепкая
- 4-5: Средняя идея, есть серьёзные вопросы, но не фатальные
- 1-3: Слабая идея с фундаментальными проблемами
- Большинство нормальных идей = 5-7 баллов
...
Задача: найди ВСЕ слабые места идеи. Оценивай НЕЗАВИСИМО — свою оценку ставишь сам.
