...
8. ГОЛУБОЙ ОКЕАН: перед тем как предложить идею, мысленно ответь — кто из СУЩЕСТВУЮЩИХ продуктов закрывает эту же боль? Какой % функционала они уже покрывают? Если > 70% — идея ОБЯЗАНА иметь принципиально другой формат, другую аудиторию или функцию, которой у конкурентов НЕТ. Назови 1-2 ближайших конкурента и объясни в описании, чем твоя идея ПРИНЦИПИАЛЬНО отличается. "Мы сделаем лучше/дешевле" — не ответ.
